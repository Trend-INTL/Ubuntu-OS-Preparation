...
git clone https://www.github.com/odoo/odoo --branch 17.0 --depth 1 /opt/odoo17/erp
...
python3.10 -m venv /opt/odoo17/erp/venv

# Activate the virtual environment
source /opt/odoo17/erp/venv/bin/activate

# Install required Python packages for Odoo
# pip install -r /opt/odoo17/erp/requirements.txt
...
; db_user = erp
db_password = False
addons_path = /opt/odoo17/erp/addons, /opt/odoo17/addons
...
Type=simple
User=$USER
ExecStart=/opt/odoo17/erp/venv/bin/python3 /opt/odoo17/erp/odoo-bin -c /etc/erp.conf -l /var/log/odoo17/erp.log
[Install]
